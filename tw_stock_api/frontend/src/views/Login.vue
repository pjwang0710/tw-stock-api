  ...
  <div>
    ...
    <section class="relative pt-16 items-center flex h-screen max-w-7xl mx-auto">
      <div class="grid mx-auto">
        <div class="mt-5">
          <img class="mx-auto h-24 w-auto" src="../assets/logo_transparent.png" alt="Workflow">
          ...
          <form class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <input id="email-address" v-model="loginInfo.email" name="email" type="email" autocomplete="email" required class="w-80 appearance-none rounded-none relative block px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Email address">
                </div>
                <div>
