          ...
          <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
              ...
              <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                ...
                <a href="/login" class="justify-center px-6 py-2 border border-transparent text-xs font-medium rounded-md text-gray-500 border-2 md:py-2 md:text-lg md:px-3">
                  登入
                </a>
                <a href="/signup" class="justify-center px-6 py-2 border border-transparent text-xs font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-2 md:text-lg md:px-3">
                  註冊
                </a>
              </div>
            </nav>
